<%-- 
    Document   : timetable
    Created on : Feb 4, 2024, 5:52:16 PM
    Author     : Admin
--%>
                        ...
                        <tr>
                            ...
                            <td> 
                                ...
                                <% 
                                        ...
                                        for(StatusStudent SS : status){
                                        if(SS.isStatus() == true && SS.getStudentCode().equals((String) request.getAttribute("CodeSt"))){
                                %>
                                <br><span style="color: green"> attendance </span>
                                <% }
                                        if(SS.isStatus() == false && SS.getStudentCode().equals((String) request.getAttribute("CodeSt"))){
        ...
        <script>
            ...
            function setTimeYear()
            {
                ...
                if (thisyear == selectYear)
                    window.location.href = "timetable?year=" + selectYear;
                else
                    window.location.href = "timetable?year=" + selectYear + "&week=" + 1;
            }
            ...
            function setTime()
            {
                ...
                window.location.href = "timetable?year=" + selectYear + "&week=" + slWeek;
            }
        </script>
    </body>
</html>
